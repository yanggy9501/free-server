...
import com.freeing.authcenter.properties.JwtProperties;
...
public class TokenConfig {
    ...
    public AuthorizationServerTokenServices tokenService() {
        ...
        // 令牌默认有效期2小时
        service.setAccessTokenValiditySeconds(jwtProperties.getAccessTokenExpire());
        // 刷新令牌默认有效期3天
        service.setRefreshTokenValiditySeconds(jwtProperties.getRefreshTokenExpire());
        return service;
    }
